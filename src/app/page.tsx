    ...
    <main className="min-h-screen bg-background py-12 px-4">
      <Card className="max-w-md mx-auto bg-card text-card-foreground shadow-xl rounded-xl overflow-hidden">
        ...
        <div className="text-center mt-6 px-6">
          <h1 className="text-2xl font-bold">Lowell Silvia</h1>
          <p className="text-muted-foreground mt-2">Brand Ambassador for Helix, based in SoCal.</p>
        </div>

        <div className="px-6 py-8 space-y-4">
          <Button variant="outline" className="w-full" asChild>
            <Link href="/skate-parks">
              My favourite skate parks
            </Link>
          </Button>
        ...
        <div className="flex justify-center gap-6 pb-8">
          ...
          <Link href="https://spotify.com" className="text-muted-foreground hover:text-foreground transition-colors">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
